    ...
    <MotionWrap className="w-full pb-24" id="projects">
      <div className="md:px-12">
        <div className="flex flex-col xl:items-start">
          ...
          <div className="flex basis-full items-center justify-center overflow-hidden bg-gray-200/25 dark:bg-yellow-600/5 px-16 pt-6 pb-8 mx-3 rounded-b-lg rounded-r-lg">
            <Carousel
              opts={{
                align: 'start',
                loop: true,
